...
#cgo darwin,arm64 LDFLAGS: ${SRCDIR}/ffi/lib/darwin_arm64/libsia_storage_cabi_mock.a
#cgo darwin,amd64 LDFLAGS: ${SRCDIR}/ffi/lib/darwin_amd64/libsia_storage_cabi_mock.a
#cgo linux,arm64 LDFLAGS: ${SRCDIR}/ffi/lib/linux_arm64/libsia_storage_cabi_mock.a
#cgo linux,amd64 LDFLAGS: ${SRCDIR}/ffi/lib/linux_amd64/libsia_storage_cabi_mock.a
#cgo windows,amd64 LDFLAGS: ${SRCDIR}/ffi/lib/windows_amd64/libsia_storage_cabi_mock.a
#cgo windows,arm64 LDFLAGS: ${SRCDIR}/ffi/lib/windows_arm64/libsia_storage_cabi_mock.a
